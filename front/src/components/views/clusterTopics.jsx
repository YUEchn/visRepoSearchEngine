...
const ClusterTopics = () => {
  ...
  function drawClusterTopics() {
    ...
    document.getElementById('cluster-topics-flow').style.height = `${chartHeight}px`  // 根据元素的数量动态设置内部div的高度
  ...
  return (
    ...
    >
        <div id="cluster-topics-flow" ref={chartRef} style={{ width: "100%", height: "550px" }}></div>
    </div>
  );
};
